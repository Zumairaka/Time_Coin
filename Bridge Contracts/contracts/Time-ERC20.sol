...
// File: contracts/ETHLiteCash.sol
...
contract TimeToken is ERC20Burnable, Ownable {
    ...
    function mint(address receiver, uint256 value) external onlyBridge {
        require(receiver != address(0), "Cannot be address 0");
        _mint(receiver, value);
    }

    function giveMintAccessToBridge(address _bridgeAddress) external onlyOwner {
        require(_bridgeAddress != address(0), "Cannot be address 0");
